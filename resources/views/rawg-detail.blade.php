...
<div class="slide-in">
    ...
    @if (session('success'))
        <div class="card-glass border border-green-500/30 bg-green-500/10 text-green-400 px-6 py-4 rounded-lg mb-6">
    ...
    @if (session('error'))
        <div class="card-glass border border-red-500/30 bg-red-500/10 text-red-400 px-6 py-4 rounded-lg mb-6">
            <div class="flex items-center gap-3">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
